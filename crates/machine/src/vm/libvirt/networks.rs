...
fn ensure_network_active(conn: &Connect, name: &str) -> Result<Network, Error> {
...
fn ensure_extra_network(conn: &Connect, name: &str, ip_hint: &str) -> Result<Network, Error> {
...
pub fn ensure_networks(conn: &Connect, sys_config: &SystemConfig) -> Result<(), Error> {
